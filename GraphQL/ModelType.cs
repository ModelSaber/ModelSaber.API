...
namespace ModelSaber.API.GraphQL
{
    public sealed class ModelType : ObjectGraphType<Model>
    {
        public ModelType()
        {
            ...
            Field<NonNullGraphType<PlatformType>>("platform", "The platform the model is for", resolve: context => context.Source.Platform);
            Field<ListGraphType<StatusType>>("status", "The status of the model", resolve: context => context.Source.Status.GetListFromFlag());
            Field<NonNullGraphType<TypeType>>("type", "What model type it is", resolve: context => context.Source.Type);
            Field(o => o.Thumbnail);
            Field<NonNullGraphType<GuidGraphType>>("id", "The id of the model", resolve: context => context.Source.Uuid);
            Field("cursor", o => WebEncoders.Base64UrlEncode(o.Uuid.ToByteArray()));
            Field(o => o.DownloadPath);
            Field(o => o.UserId, type: typeof(NonNullGraphType<ULongGraphType>));
            Field(o => o.Nsfw, type: typeof(NonNullGraphType<BooleanGraphType>));
